...
public static class Log
{
    ...
    public static void Warning<T0, T1, T2>(string messageTemplate, T0 propertyValue0, T1 propertyValue1, T2 propertyValue2) => Logger.Warning(messageTemplate, propertyValue0, propertyValue1, propertyValue2);
    public static void Warning(Exception? exception, string messageTemplate) => Logger.Warning(exception, messageTemplate);
    public static void Warning<T>(Exception? exception, string messageTemplate, T propertyValue) => Logger.Warning(exception, messageTemplate, propertyValue);
    public static void Warning<T0, T1>(Exception? exception, string messageTemplate, T0 propertyValue0, T1 propertyValue1) => Logger.Warning(exception, messageTemplate, propertyValue0, propertyValue1);
