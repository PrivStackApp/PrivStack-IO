...
public sealed class PrivStackService : IPrivStackNative
{
    ...
    /// </summary>
    private static readonly string[] StandardVaultIds = ["connections", "ai-vault"];
    ...
    public void StartSync()
    {
        ...
        ServiceProviderAccessor.Services.GetRequiredService<Services.Abstractions.ISyncIngestionService>().Start();
    }
    ...
    public void StopSync()
    {
        ...
        ServiceProviderAccessor.Services.GetRequiredService<Services.Abstractions.ISyncIngestionService>().Stop();
