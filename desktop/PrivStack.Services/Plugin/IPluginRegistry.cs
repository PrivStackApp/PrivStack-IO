...
namespace PrivStack.Services.Plugin;
...
public interface IPluginRegistry
{
    ...
    /// <summary>
    /// Sets the main window ViewModel (or host object) for cross-plugin navigation.
    /// Desktop passes MainWindowViewModel; headless passes null or a stub.
    /// </summary>
    void SetMainViewModel(object? mainViewModel);

    /// <summary>
    /// Gets the main window ViewModel (or host object).
    /// Callers that need the concrete type should cast.
    /// </summary>
