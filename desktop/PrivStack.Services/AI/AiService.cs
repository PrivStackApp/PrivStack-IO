...
internal sealed class AiService : IAiService
{
    ...
    private readonly IEnumerable<KeyValuePair<string, IAiProvider>> _extraProviders;
    ...
    public AiService(
        ...
        IEnumerable<KeyValuePair<string, IAiProvider>>? extraProviders = null)
    {
        _appSettings = appSettings;
        _sdk = sdk;
        _modelManager = modelManager;
        _extraProviders = extraProviders ?? [];
    }
    ...
    private void EnsureProviders()
    {
        ...
        // Add platform-specific providers (e.g., Desktop registers LocalLlamaProvider)
        foreach (var kvp in _extraProviders)
