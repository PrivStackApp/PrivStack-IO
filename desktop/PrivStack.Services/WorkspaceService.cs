...
public sealed partial class WorkspaceService : IWorkspaceService
{
    ...
    public void SwitchWorkspace(string workspaceId)
    {
        ...
        ServiceProviderAccessor.Services.GetService<ViewStatePrefetchService>()?.Clear();
        ...
        var service = ServiceProviderAccessor.Services.GetRequiredService<Native.IPrivStackRuntime>();
        ...
        try
        {
            ...
            var authService = ServiceProviderAccessor.Services.GetRequiredService<IAuthService>();
            var passwordCache = ServiceProviderAccessor.Services.GetService<IMasterPasswordCache>();
