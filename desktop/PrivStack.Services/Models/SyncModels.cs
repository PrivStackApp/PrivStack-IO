...
public class DiscoveredPeer
{
    ...
    /// <summary>
    /// Gets a semantic category for discovery method (for UI brush resolution).
    /// Values: "success" (Mdns), "primary" (Dht), "muted" (other).
    /// </summary>
    public string DiscoveryCategory => DiscoveryMethod switch
    {
        "Mdns" => "success",
        "Dht" => "primary",
        _ => "muted"
